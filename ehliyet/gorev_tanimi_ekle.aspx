<%@ Page Title="" Language="C#" MasterPageFile="~/Anasablon.Master" AutoEventWireup="true" CodeBehind="gorev_tanimi_ekle.aspx.cs" Inherits="WMSDATA.gorev_tanimi_ekle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <form id="gorev_tanimi_ekle" runat="server">
                 ...
                 <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 2-r"><h3 class="m-t-none m-b"></h3>
                                ...
                                <asp:Textbox name="textarea-input" id="gorevidm"  runat="server" AutoPostBack="True"  OnTextChanged="gorev_Getir" placeholder="Görev Id.." class="form-control col-sm-4 b-r" required="" ></asp:Textbox>  
                                &nbsp 
                                      <textarea name="textarea-input" id="gorevim"  runat="server" style="text-transform:uppercase" placeholder="Görev.."  class="form-control col-sm-4 b-r" rows="1" required="" ></textarea>
      ...
      <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <thead>
                    <tr><th>SEÇ</th>
                                      <th data-hide="phone,tablet">GÖREV ID</th>
                                      <th data-hide="phone,tablet">PERSONEL GÖREVİ</th>
