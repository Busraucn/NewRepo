<%@ Page Title="" Language="C#" MasterPageFile="~/Anasablon.Master" AutoEventWireup="true" CodeBehind="proje_kayit.aspx.cs" Inherits="WMSDATA.proje_kayit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <form id="proje_kayit" runat="server">
             ...
             <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>PROJE KAYDET <small>  </small></h5>
                 ...
                 <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 2-r"><h3 class="m-t-none m-b"></h3>
                                ...
                                <asp:Textbox name="textarea-input" disabled id="ProjeId"  runat="server" AutoPostBack="True"  placeholder="Proje Id.." class="form-control col-sm-4 b-r" required="" ></asp:Textbox>  
                                &nbsp 
                                      <textarea name="textarea-input" id="projeno"  runat="server" style="text-transform:uppercase" placeholder="Proje Kodu.."  class="form-control col-sm-4 b-r" rows="1" required="" ></textarea>
                                   
                                    &nbsp 
                                      <textarea name="textarea-input" id="acikalama"  runat="server" style="text-transform:uppercase" placeholder="Proje Açıklama.."  class="form-control col-sm-4 b-r" rows="1" required="" ></textarea>
                                    &nbsp 
                                    ...
                                    <% if( departmankodus [i] !="" && departmankodus [i] !=null  ){ %>
                                     ...
                                     <td><%=departmanadis [i]%>  </td>
                                      ...
                                      <td><%=departmanyoneticis [i] %>  </td>
                                                                               <td><a type="button" class="btn btn-primary" href="proje_kayit.aspx?uyeid=<%=idm[i] %>" >
                                DÜZENLE
                            </a>
