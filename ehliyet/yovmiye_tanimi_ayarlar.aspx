<%@ Page Title="" Language="C#" MasterPageFile="~/Anasablon.Master" AutoEventWireup="true" CodeBehind="yovmiye_tanimi_ayarlar.aspx.cs" Inherits="WMSDATA.yovmiye_tanimi_ayarlar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <form id="yovmiye_tanimi_ayarlar" runat="server">
     
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>YÖVMİYE TANIMI AYARLAR</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="ansayfa.aspx">Anasayfa</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a>YÖVMİYE TANIMI AYARLAR</a>
                        </li>
                 ...
                 <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 2-r"><h3 class="m-t-none m-b"></h3>
                                   ...
                                   <label>SEÇİLEN YÖVMİYE:&nbsp<textarea name="textarea-input" id="secilenid"  disabled runat="server"    class="form-control col-sm-4 b-r" rows="1"  required="" ></textarea> </label>
                               </div>
                             ...
                             <label>ÇALIŞMA SÜRESİ :&nbsp<textarea name="textarea-input" id="CALISMASURESI"  runat="server"    class="form-control col-sm-4 b-r" rows="1"  required="" ></textarea>  </label>
                             <label>YÖVMİYE MİKTARI:&nbsp<textarea name="textarea-input" id="YOVMIYEMIKTARI"  runat="server"   class="form-control col-sm-4 b-r" rows="1"  required="" ></textarea>  </label>
                    ...
                    <tr><th>SEÇ</th>
                     ...
                     <td>  
                                    ...
                                    <td><%=HAFTATATILGUNSAYISIm [i] %>  </td>
                                           ...
                                           <td><a type="button" class="btn btn-primary" href="yovmiye_tanimi_ayarlar.aspx?uyeid=<%=idm[i] %>" >
                                DÜZENLE
                            </a>
