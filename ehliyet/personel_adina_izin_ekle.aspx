<%@ Page Title="" Language="C#" MasterPageFile="~/Anasablon.Master" AutoEventWireup="true" CodeBehind="personel_adina_izin_ekle.aspx.cs" Inherits="WMSDATA.personel_adina_izin_ekle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <form id="personel_adina_izin_ekle" runat="server">
                 ...
                 <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 2-r"><h3 class="m-t-none m-b"></h3>
                                ...
                                <label></label>
                                    <div>   
                                      <textarea name="textarea-input" id="tckimlik"  runat="server"  disabled placeholder="TC Kimlik No.." class="form-control col-sm-4 b-r" rows="1" required="" ></textarea>  
                                      &nbsp 
                            ...
                            <div>
                              ...
                              <label>TOPLAM KALAN İZİN&nbsp<textarea name="textarea-input" id="yilicikalan"  runat="server"  disabled  class="form-control col-sm-4 b-r" rows="1"  required="" ></textarea> </label>  
                                      ...
                                      <div>
                                         <asp:ListBox  id="isimlers3" runat ="server" style="display:none" class="col-sm-4" required="">
                                   </asp:ListBox>
                                           </div>
                           </div> 
                          </div>
                             ...
                             <div class="form-group">
                             <fieldset><label>RAPOR DURUMU:</label> &nbsp <select id="rapordurum1" name="rapordurum" runat="server">
                             <option value=""></option>
                             <option value="RAPORLU">RAPORLU</option>
                             <option value="RAPORSUZ">RAPORSUZ</option> </select> </fieldset> </div>  
                                ...
                                <input runat ="server" href="#" type="date" required="" id="izinbaslangictarihi" class="form-control col-sm-4"></>
                                                                                             ...
                                                                                             <div class="form-group"><label>İŞE BAŞLANGIÇ TARİHİ:</label>
