<%@ Page Title="" Language="C#" MasterPageFile="~/Anasablon.Master" AutoEventWireup="true" CodeBehind="proje_tip_kayit.aspx.cs" Inherits="WMSDATA.proje_tip_kayit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <form id="proje_tip_kayit" runat="server">
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>PROJE TİPİ Kaydet</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="ansayfa.aspx">Anasayfa</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a>PROJE TİPİ Kaydet</a>
                        </li>
                    </ol>
                   </div>
                  <div class="col-lg-2">
             ...
             <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>PROJE TİPİ KAYDET <small>  </small></h5>
                 ...
                 <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 2-r"><h3 class="m-t-none m-b"></h3>
                                <asp:Textbox name="textarea-input" id="projetipid"  runat="server" AutoPostBack="True"  placeholder="Proje Id.." class="form-control col-sm-4 b-r" required="" ></asp:Textbox>  
                                &nbsp 
                                <textarea name="textarea-input" id="projetip"  runat="server" style="text-transform:uppercase" placeholder="Proje Tipi.."  class="form-control col-sm-4 b-r" rows="1" required="" ></textarea>
                                &nbsp 
                                <textarea name="textarea-input" id="projeaciklama"  runat="server" style="text-transform:uppercase" placeholder="Açıklama.."  class="form-control col-sm-4 b-r" rows="1" required="" ></textarea>
                            </div>  
                           </div>
                          </div>
                        </div>
      ...
      <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <thead>
                    <tr><th>SEÇ</th>
                                      <th data-hide="phone,tablet">PROJE TİP ID</th>
